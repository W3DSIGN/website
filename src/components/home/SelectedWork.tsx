...
export const SelectedWork = () => {
  ...
  return (
    <section id="latest-projects" className="w-full bg-white md:py-24 p-4">
      {/* Title */}
      <div className="w-full px-4 mb-8 md:mb-12 pb-4 overflow-hidden -mx-4">
        {/* Mobile Title - 2 Rows */}
        <div className="md:hidden">
          <h2 className="text-[15vw] leading-none text-black font-kode-mono flex flex-col">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="md:hidden space-y-2">
                <div className="text-black font-kode-mono text-xl leading-tight">
                  {project.name}
                </div>
                <div className="text-black font-kode-mono text-base">
                  {project.collection}
                </div>
                <div className="text-black font-kode-mono text-base">
                  {project.location}
              ...
              <div className="hidden md:grid md:grid-cols-4 gap-4 items-center">
                <div className="text-black font-kode-mono text-lg lg:text-xl">
                  {project.name}
                </div>
                <div className="text-black font-kode-mono text-lg lg:text-xl">
                  {project.collection}
